...
$table_sql = "CREATE TABLE IF NOT EXISTS eoi (
    ...
    visa_class ENUM('Citizen','Tempory visa') NOT NULL,
...
(first_name, last_name, dob, gender, street_address, suburb_town, state, postcode, email, country_code, phone, job_role, job_reference, visa_class, skills, other_skill)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"; 
