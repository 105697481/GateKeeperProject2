...
$other_skill = $_SESSION['other_skill'] ?? '';
...
<head>
    ...
    <link rel="stylesheet" href="styles_apply/styles.css">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <select id="Job_Reference" name="job_reference" required>
                        ...
                        <option value="senior-security-analyst" <?php if($job_reference=="SEC01") echo "selected"; ?>>SEC01</option>
                        <option value="junior-penetration-tester" <?php if($job_reference=="PEN02") echo "selected"; ?>>PEN02</option>
                        <option value="cybersecurity-intern" <?php if($job_reference=="INT03") echo "selected"; ?>>INT03</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select id="Visa Class" name="visa_class" required>
                        <option value="">Select</option>
                        <option value="full-time" <?php if($visa_class=="Citizen") echo "selected"; ?>>Citizen</option>
                        <option value="part-time" <?php if($visa_class=="Tempory visa") echo "selected"; ?>>Tempory visa</option>
                    </select>
